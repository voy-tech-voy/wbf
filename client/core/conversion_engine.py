...
# =============================================================================
# Each preset: (dither_level, fps, colors, resolution_percent)
...
# Default to standard (will be selected based on auto_resize param)
QUALITY_PRESETS = QUALITY_PRESETS_STANDARD
